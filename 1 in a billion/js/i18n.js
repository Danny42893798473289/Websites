...
const UI = {
  en: {
    ...
    "social.grantCurrencies": "Apply Grants",
    ...
    "settings.popupMinRarity": "Egg popup from rarity",
    ...
    "fusion.autoToggle": "Enable Auto-Fusion",
    "fusion.autoHint": "Automatically crafts one fusion at a time: base recipes first, then advanced, then super.",
    "fusion.autoLocked": "Unlock Auto Fusion Lab in Ascension (3 AP) to enable.",
    "fusion.autoOff": "Auto: off",
    "fusion.autoOn": "Auto: on (next in {time})",
    "fusion.autoWaiting": "Auto: on (waiting for ingredients)",
    "fusion.autoBatch": "Auto-fusion crafted {n} fusions.",
    ...
    "asc.costApOnly": "Cost: {cost} AP",
    "asc.ascFusionEffect": "Unlock auto-fusion toggle in Fusion Lab",
    "asc.ascFusionSpeedEffect": "+{n}% fusion speed per level",
    "asc.ascLuckEffect": "+{n}% permanent luck per level",
    "asc.ascCoinsEffect": "+{n}% permanent coins per level",
    "asc.ascRpsEffect": "+{n} permanent RPS per level",
    "set.setName": "{name} Set",
    "achievement.locked": "Locked",
    "achievement.unlocked": "Unlocked",
    "social.adminHintLong": "Danny only. Grant currencies to any account (including yourself). Use 0 to skip a field; negative values deduct. New accounts are auto-created with a temporary password.",
  ...
  zh: {
    ...
    "settings.sound": "音效",
    "settings.popupMinRarity": "蛋弹窗最低稀有度",
    ...
    "fusion.autoToggle": "启用自动融合",
    "fusion.autoHint": "自动逐个融合：先基础配方，再高级，最后超级。",
    "fusion.autoLocked": "在飞升中解锁自动融合实验室（3 飞升点）后可用。",
    "fusion.autoOff": "自动：关",
    "fusion.autoOn": "自动：开（{time} 后下次）",
    "fusion.autoWaiting": "自动：开（等待材料）",
    "fusion.autoBatch": "自动融合已完成 {n} 次。",
    "companion.hatch": "孵化",
    ...
    "asc.costApOnly": "费用：{cost} 飞升点",
    "asc.ascFusionEffect": "解锁融合实验室中的自动融合开关",
    "asc.ascFusionSpeedEffect": "每级 +{n}% 融合速度",
    "asc.ascLuckEffect": "每级 +{n}% 永久幸运",
    "asc.ascCoinsEffect": "每级 +{n}% 永久金币",
    "asc.ascRpsEffect": "每级 +{n} 永久 RPS",
    "set.setName": "{name} 套装",
    "achievement.locked": "未解锁",
    "achievement.unlocked": "已解锁",
    "social.adminHintLong": "仅 Danny 可用。可向任意账号（含自己）发放货币。填 0 表示跳过；负数表示扣除。不存在的账号将自动创建并设置临时密码。",
    "theme.gemsCost": "{n} 宝石",
    "asc.reqTitle": "飞升条件",
